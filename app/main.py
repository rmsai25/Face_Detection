...
class FaceDetectionSystem:
    def __init__(self, registration_mode=False):
        ...
        try:
            ...
            self.logger.info(f"Initialized in {'registration' if self.registration_mode else 'recognition'} mode")
    ...
    def load_known_faces(self):
        try:
            ...
            self.logger.info(f"Loaded {len(users)} faces from DB")
        except Exception as e:
    ...
    def toggle_registration_mode(self):
        ...
        self.logger.info(f"Toggled to {mode} mode")
        return mode
...
def main():
    ...
    if args.mode == "server":
        ...
        print("Press 'q' to quit | 'r' to toggle mode\n")
